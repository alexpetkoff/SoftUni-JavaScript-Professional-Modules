...
export const InfoUserModal = ({ id, onClick }) => {
                ...
                <div className="detail-container">
                    ...
                    <div className="content">
                        ...
                        <div className="user-details">
                            ...
                            <p>Created on: <strong>{changeDateFormat(userInfo.createdAt)}</strong></p>
                            <p>Modified on: <strong>{changeDateFormat(userInfo.updatedAt)}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
